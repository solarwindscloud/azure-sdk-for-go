...
// workspaceName - name of Azure Machine Learning workspace.
// computeName - name of the Azure Machine Learning compute.
func (client MachineLearningComputeClient) ListNodes(ctx context.Context, resourceGroupName string, workspaceName string, computeName string) (result ComputeNodesInformationModel, err error) {
	if tracing.IsEnabled() {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "services.MachineLearningComputeClient", "ListNodes", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "services.MachineLearningComputeClient", "ListNodes", resp, "Failure sending request")
		return
	}

	result, err = client.ListNodesResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "services.MachineLearningComputeClient", "ListNodes", resp, "Failure responding to request")
	}
...
// closes the http.Response Body.
func (client MachineLearningComputeClient) ListNodesResponder(resp *http.Response) (result ComputeNodesInformationModel, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		azure.WithErrorUnlessStatusCode(http.StatusOK),
...
func (client MachineLearningComputeClient) Update(ctx context.Context, resourceGroupName string, workspaceName string, computeName string, parameters ClusterUpdateParameters) (result MachineLearningComputeUpdateFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "services.MachineLearningComputeClient", "Update", nil, "Failure preparing request")
		return
	}

	result, err = client.UpdateSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "services.MachineLearningComputeClient", "Update", result.Response(), "Failure sending request")
		return
	}
