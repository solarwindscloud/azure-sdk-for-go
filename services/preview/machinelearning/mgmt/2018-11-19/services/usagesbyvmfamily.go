...
func (client UsagesByVMFamilyClient) ListPreparer(ctx context.Context, location string) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/providers/Microsoft.MachineLearningServices/locations/{location}/resourceUsagesByVMFamily", pathParameters),
